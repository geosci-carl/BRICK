...
**Key Contributions:**
* **Probabilistic Calibration:** Executed and validated Markov Chain Monte Carlo (MCMC) calibration pipelines across coupled sub-models (DOECLIM, SIMPLE, DAIS) using observational climate and sea-level datasets and structured expert judgment (SEJ).
